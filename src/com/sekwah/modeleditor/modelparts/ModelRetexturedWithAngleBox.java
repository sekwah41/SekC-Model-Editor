...
public class ModelRetexturedWithAngleBox extends ModelBox {
	...
	public ModelRetexturedWithAngleBox(ModelRetexturedWithAngleBox parent, String name, int xWidth, int yWidth, int zWidth, float xOffset, float yOffset, float zOffset, int xTextureOffset, int yTextureOffset, float sizeScaler, int xTop, int yTop, int xBot, int yBot){
